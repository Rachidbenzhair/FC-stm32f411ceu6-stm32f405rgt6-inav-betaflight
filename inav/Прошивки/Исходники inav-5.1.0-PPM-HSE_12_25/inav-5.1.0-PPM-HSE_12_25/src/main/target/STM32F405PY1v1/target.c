...
timerHardware_t timerHardware[] = {
    ...
    DEF_TIM(TIM2, CH1,  PA15, TIM_USE_MC_MOTOR | TIM_USE_FW_SERVO, 0, 0), // S9
    DEF_TIM(TIM2, CH2,  PB3,  TIM_USE_MC_MOTOR | TIM_USE_FW_SERVO, 0, 0), // S10
    ...
    DEF_TIM(TIM2, CH1,  PA15, TIM_USE_MC_SERVO | TIM_USE_FW_SERVO, 0, 0), // S5
    DEF_TIM(TIM2, CH2,  PB3,  TIM_USE_MC_SERVO | TIM_USE_FW_SERVO, 0, 0), // S6

#endif

    DEF_TIM(TIM3, CH1,  PB4,  TIM_USE_LED,    0, 0),
